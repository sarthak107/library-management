...
export default function NavBar(){
    return (
        <div className="min-h-[3rem] p-2 shadow-lg flex items-center justify-evenly w-[100%]">
            ...
            <div className="w-[0.5px] h-[2rem] bg-black"></div>
            <Link href={'/transactions'} className="py-1 flex items-center justify-center w-[17rem] h-[2.5rem] rounded-lg navbutton ease-in-out duration-300 hover:tracking-wider">Transactions</Link>
